    ...
    >
      <AnimatePresence mode="popLayout">
        {isHovered && (
          ...
          >
            <div className="font-bold text-gray-900 relative z-30 text-base text-center">{item.name}</div>
            <div className="text-gray-600 text-xs text-center">{item.designation}</div>
          </motion.div>
        )}
      </AnimatePresence>
      <motion.div
